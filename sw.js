...
self.addEventListener('fetch',e=>{
  ...
  e.respondWith((async()=>{
    ...
    const extraStyle='<style>.homeHeader{position:sticky!important;top:0!important;z-index:40!important}.subHeader{position:sticky!important;top:0!important;z-index:40!important}.portalStack{width:42px;height:42px;border:1px solid rgba(255,255,255,.22);border-radius:12px;background:rgba(255,255,255,.14);color:#fff;text-decoration:none;display:flex;flex-direction:column;align-items:center;justify-content:center;line-height:1}.portalStack strong{font-size:15px;font-weight:900}.portalStack small{font-size:6px;font-weight:800;margin-top:3px;letter-spacing:.01em}.subPortal{margin-left:auto;background:#fff!important;color:#172033!important;border-color:#e8edf2!important}</style>';
